...
public partial class Admin_ModifyQiCai : System.Web.UI.Page
{
    ...
    private void getdata(string sql)
    {
        ...
        if (dr.Read())
        {
            ...
            TextBox2.Text = dr["JiaGe"].ToString();
    ...
    {
        //更新修改后的信息到数据库表中。。。
        sql = "update QiCai set name='" + Label2.Text.ToString().Trim() + "',content='" + content1.Value + "',LeiXing='" + DropDownList2.SelectedValue + "',JiaGe='" + TextBox2.Text + "',Photo='" + pic.Text + "' where id=" + dID;
        data.RunSql(sql);
        Alert.AlertAndRedirect("修改成功", "QiCaiManger.aspx");
    }
