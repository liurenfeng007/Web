...
public partial class Admin_ModifyKeCheng : System.Web.UI.Page
{
    ...
    private void getdata(string sql)
    {
        ...
        if (dr.Read())
        {
            ...
            DropDownList2.Items.FindByValue(dr["JiaoLian"].ToString()).Selected = true;
    ...
    {
        //更新修改后的信息到数据库表中。。。
        sql = "update KeCheng set name='" + Label2.Text.ToString().Trim() + "',content='" + content1.Value + "',ZhuangTai='" + DropDownList1.SelectedValue + "',JiaoLian='" + DropDownList2.SelectedValue + "',FeiYong='" + TextBox2.Text + "',Photo='" + pic.Text + "' where id=" + dID;
        data.RunSql(sql);
        Alert.AlertAndRedirect("修改成功", "KeChengManger.aspx");
    }
