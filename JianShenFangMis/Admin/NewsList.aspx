 ...
 <td height="26" >
  ...
  <td align="center" style="height: 22px">
     ...
     <asp:Label ID="Label4" runat="server" ForeColor="Red"  Text=""></asp:Label></td>
        ...
        <tr>
            <td height="26">
                信息类别：<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                    Width="213px">
                </asp:DropDownList></td>
        </tr>
</table>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="标题">
                                <ItemTemplate>
                                    <asp:Label ID="title" runat="server" Text='<%# Bind("name") %>'  Width="287px"></asp:Label>
                                </ItemTemplate>
