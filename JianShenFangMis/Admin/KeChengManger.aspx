<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KeChengManger.aspx.cs" Inherits="Admin_KeChengManger" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="课程状态">
                               ...
                               <asp:TemplateField HeaderText="课程教练">
                                <ItemTemplate>
                                    <asp:Label ID="JiaoLian" runat="server" Text='<%# Bind("JiaoLian") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyKeCheng.aspx?id="+Eval("id") %>'
