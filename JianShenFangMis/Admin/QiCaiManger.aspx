<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QiCaiManger.aspx.cs" Inherits="Admin_QiCaiManger" %>
            ...
            <tr align="right" bgcolor="#eef4ea">
                <td align="left" colspan="10" height="36">
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="器材名称">
                                <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="器材类型">
                                <ItemTemplate>
                              ...
                              <asp:TemplateField HeaderText="器材价格">
                                <ItemTemplate>
                                    <asp:Label ID="JiaGe" runat="server" Text='<%# Bind("JiaGe") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyQiCai.aspx?id="+Eval("id") %>'
