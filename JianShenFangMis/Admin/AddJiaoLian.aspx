<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddJiaoLian.aspx.cs"  ValidateRequest="false" EnableEventValidation="false"  Inherits="Admin_AddJiaoLian" %>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    教练姓名：<asp:TextBox ID="title" runat="server" Style="border-right: #ffcc00 1px solid;
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    登录账号：<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox2"
                        ErrorMessage="必填"></asp:RequiredFieldValidator></td>
            </tr>
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    登录密码：<asp:TextBox ID="TextBox3" runat="server" TextMode="Password"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox3"
                        ErrorMessage="必填"></asp:RequiredFieldValidator></td>
            </tr>
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    教练类别：<asp:DropDownList ID="DropDownList1" runat="server" Width="275px" AutoPostBack="True"  >
                    </asp:DropDownList></td>
            </tr>
            <tr bgcolor="#e7e7e7">
                <td colspan="10" style="height: 24px">
                    每小时价格：<asp:TextBox ID="TextBox1" runat="server" Style="border-right: #ffcc00 1px solid;
                        border-top: #ffcc00 1px solid; border-left: #ffcc00 1px solid; border-bottom: #ffcc00 1px solid"
