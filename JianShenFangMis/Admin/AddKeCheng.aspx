<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddKeCheng.aspx.cs"ValidateRequest="false" EnableEventValidation="false"  Inherits="Admin_AddKeCheng" %>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    课程名称：<asp:TextBox ID="title" runat="server" Style="border-right: #ffcc00 1px solid;
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" style="height: 24px">
                    课程教练：<asp:DropDownList ID="DropDownList2" runat="server" Width="122px" AutoPostBack="True"  >
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" style="height: 24px">
                    ...
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="上传课程图片" />
