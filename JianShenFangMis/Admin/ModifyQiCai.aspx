<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyQiCai.aspx.cs" ValidateRequest="false" EnableEventValidation="false"  Inherits="Admin_ModifyQiCai" %>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    器材名称：<asp:Label ID="Label2" runat="server"></asp:Label></td>
            </tr>
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    器材类型：<asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" Width="92px">
                    ...
                    <asp:ListItem>健身室器材</asp:ListItem>
