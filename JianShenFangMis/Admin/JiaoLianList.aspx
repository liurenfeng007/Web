<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JiaoLianList.aspx.cs" Inherits="Admin_JiaoLianList" %>
 ...
 <td style="height: 25px" >
  ...
  <td align="center" style="height: 22px">
     ...
     <asp:Label ID="Label4" runat="server" ForeColor="Red" Text=""></asp:Label></td>
        ...
        <tr>
            <td height="26">
                教练类别：<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                    Width="213px">
                </asp:DropDownList></td>
        </tr>
</table>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="姓名">
                                <ItemTemplate>
                                    <asp:Label ID="title" runat="server" Text='<%# Bind("name") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                                 <asp:TemplateField HeaderText="账号">
                                <ItemTemplate>
                                    <asp:Label ID="LoginName" runat="server" Text='<%# Bind("LoginName") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="LoginPwd" runat="server" Text='<%# Bind("LoginPwd") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="分类">
                                <ItemTemplate>
                                    <asp:Label ID="leibie" runat="server" Text='<%# Bind("TypeName") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                              <asp:TemplateField HeaderText="每节课费用">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "tpJiaoLian_updt.aspx?id="+Eval("id") %>'
