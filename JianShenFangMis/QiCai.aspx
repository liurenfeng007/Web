<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QiCai.aspx.cs" Inherits="QiCai" Title="Untitled Page" %>
        ...
        <tbody>
            <tr>
                <td align="center"   class="tabTitle" colspan="1" height="22"
                    style="width: 100%">
                    <b>器材名称：<asp:Label ID="Label2" runat="server" Width="100%"></asp:Label></b></td>
            </tr>
            <tr>
                <td align="center"   class="tabTitle" colspan="1" style="width: 100%;
                    height: 22px">
                    添加时间：<asp:Label ID="Label1" runat="server" Width="21%"></asp:Label>器材类型：<asp:Label
                        ID="Label3" runat="server" Width="13%"></asp:Label>器材价格：<asp:Label ID="Label6" runat="server" Width="13%"></asp:Label></td>
            </tr>
            <tr>
                <td align="center"   class="tabTitle" colspan="1" style="width: 100%;
                    height: 22px">
